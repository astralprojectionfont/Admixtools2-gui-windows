    ...
    for size in range(model_min, model_max + 1):
        for combo in combinations(rotation_pool_pops, size):
            ...
            if set(left) & set(right):
                continue  # Skip if there's overlap between left and right
...
right_entry = tk.Entry(scrollable_frame, width=70)
right_entry.grid(row=2, column=1, columnspan=2, padx=5, pady=2, sticky='we')
